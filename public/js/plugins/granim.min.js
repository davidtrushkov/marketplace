...
var require;var require;/*! Granim v1.1.0 - https://sarcadass.github.io/granim.js */
!function t(e, i, s) {
  function n(a, r) {
    if (!i[a]) {
      if (!e[a]) {
      ...
      }var l = i[a] = { exports: {} };e[a][0].call(l.exports, function (t) {
        var i = e[a][1][t];return n(i ? i : t);
      }, l, l.exports, t, e, i, s);
    }return i[a].exports;
    ...
    e.exports = function () {
      var t,
          e,
          i = [];for (t = 0; t < this.currentColors.length; t++) {
        for (i.push([]), e = 0; e < 3; e++) {
    ...
    e.exports = function (t) {
      if (t instanceof HTMLCanvasElement) this.canvas = t;else {
        if ("string" != typeof t) throw new Error("The element you used is neither a String, nor a HTMLCanvasElement");this.canvas = document.querySelector(t);
    ...
    e.exports = function () {
      var t,
        ...
        s = null === s ? n[e] : s + n[e], e === n.length - 1 && (t = Math.round(s / (e + 1)));
      }return t >= 128 ? "light" : "dark";
    };
  }, {}], 14: [function (t, e, i) {
    "use strict";
    e.exports = function (t) {
      var e = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;t = t.replace(e, function (t, e, i, s) {
        return e + e + i + i + s + s;
      });var i = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return i ? [parseInt(i[1], 16), parseInt(i[2], 16), parseInt(i[3], 16)] : null;
    };
  }, {}], 15: [function (t, e, i) {
    "use strict";
    e.exports = function () {
      var t,
          e,
          i = this.setDirection(),
          s = document.querySelector(this.elToSetClassOn).classList;for (this.shouldClearCanvasOnEachFrame && this.context.clearRect(0, 0, this.x1, this.y1), this.image && this.context.drawImage(this.imageNode, this.imagePosition.x, this.imagePosition.y, this.imagePosition.width, this.imagePosition.height), t = 0; t < this.currentColors.length; t++) {
        e = t ? (1 / (this.currentColors.length - 1) * t).toFixed(2) : 0, i.addColorStop(e, "rgba(" + this.currentColors[t][0] + ", " + this.currentColors[t][1] + ", " + this.currentColors[t][2] + ", " + this.opacity[t] + ")");
    ...
    "use strict";
    e.exports = function (t) {
      var e = "isPausedBecauseNotInView" === t;this.isCleared || (e || (this.isPaused = !0), cancelAnimationFrame(this.animation), this.animating = !1);
    };
  }, {}], 19: [function (t, e, i) {
    "use strict";
    e.exports = function () {
      var t = this;this.scrollDebounceTimeout && clearTimeout(this.scrollDebounceTimeout), this.scrollDebounceTimeout = setTimeout(function () {
        var e = t.canvas.getBoundingClientRect();if (t.isCanvasInWindowView = !(e.bottom < 0 || e.right < 0 || e.left > window.innerWidth || e.top > window.innerHeight), t.isCanvasInWindowView) {
          if (!t.isPaused || t.firstScrollInit) {
            if (t.image && !t.isImgLoaded) return;t.isPausedBecauseNotInView = !1, t.play("isPlayedBecauseInView"), t.firstScrollInit = !1;
          }
    ...
    "use strict";
    e.exports = function (t) {
      var e = "isPlayedBecauseInView" === t;e || (this.isPaused = !1), this.isCleared = !1, this.animating || (this.animation = requestAnimationFrame(this.animateColors.bind(this)), this.animating = !0);
    };
  }, {}], 21: [function (t, e, i) {
    "use strict";
    e.exports = function () {
      function t() {
        function t(t) {
          var i,
              ...
              o = "x" === t ? e.image.position[0] : e.image.position[1];switch (o) {case "center":
              i = n > s ? -(n - s) / 2 : (s - n) / 2, e.imagePosition[t] = i, e.imagePosition["x" === t ? "width" : "height"] = n;break;case "top":
              e.imagePosition.y = 0, e.imagePosition.height = n;break;case "bottom":
              e.imagePosition.y = s - n, e.imagePosition.height = n;break;case "right":
              e.imagePosition.x = s - n, e.imagePosition.width = n;break;case "left":
              e.imagePosition.x = 0, e.imagePosition.width = n;}if (e.image.stretchMode) switch (o = "x" === t ? e.image.stretchMode[0] : e.image.stretchMode[1]) {case "stretch":
              e.imagePosition[t] = 0, e.imagePosition["x" === t ? "width" : "height"] = s;break;case "stretch-if-bigger":
              if (n < s) break;e.imagePosition[t] = 0, e.imagePosition["x" === t ? "width" : "height"] = s;break;case "stretch-if-smaller":
              if (n > s) break;e.imagePosition[t] = 0, e.imagePosition["x" === t ? "width" : "height"] = s;}
        }var i, s;for (i = 0; i < 2; i++) {
          s = i ? "y" : "x", t(s);
        }
      }var e = this;return this.imagePosition || (this.imagePosition = { x: 0, y: 0, width: 0, height: 0 }), this.image.blendingMode && (this.context.globalCompositeOperation = this.image.blendingMode), this.imageNode ? void t() : (this.imageNode = new Image(), this.imageNode.onerror = function () {
    ...
    e.exports = function (t) {
      var e,
          i,
          s,
          n = this;for (i = 0; i < this.activeColors.length; i++) {
        for (s = 0; s < 3; s++) {
          e = n.activeColors[i][s] + Math.ceil(n.activeColorDiff[i][s] / 100 * t), e <= 255 && e >= 0 && (n.currentColors[i][s] = e);
        }
      }this.makeGradient();
    };
  }, {}], 23: [function (t, e, i) {
    ...
    e.exports = function () {
      var t = this.context;switch (this.direction) {default:
          this.triggerError("direction");break;case "diagonal":
    ...
    "use strict";
    e.exports = function (t) {
      var e = "https://sarcadass.github.io/granim.js/api.html";throw new Error('Granim: Input error on "' + t + '" option.\nCheck the API ' + e + ".");
    };
  }, {}], 27: [function (t, e, i) {
    "use strict";
    e.exports = function (t) {
